...
public class BookServiceImpl implements BookService {
    ...
    private static final String BOOKS_FILE_PATH = "D:\\Documents\\School\\=IT\\=Java SoftUni\\03.2-Java SpringData" +
            "\\Exercises\\6.Spring Data Advanced Querying\\Advanced_Querying\\src\\main\\resources\\files\\books.txt";
    ...
    @Override
    public List<Book> findAllWIthPriceNotBetween(int lowerBound, int upperBound) {
    ...
    @Override
    public List<Book> findByContaining(String containing) {
        return this.bookRepository.findByTitleContaining(containing);
    }
