...
public interface DBContext<E> {
    ...
    E findFirst(Class<E> entityType, String where) throws SQLException, NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException;
