...
public class P04_AddMinions {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        ResultSet lastMinions = getLastMinion.executeQuery();
        lastMinions.next();
        int lastMinionId = lastMinions.getInt("id");
    ...
    private static int getOrInsertVillain(Connection connection, String villainName) throws SQLException {
        ...
        if (!villainSet.next()) {
            ...
            ResultSet villainSetUpdated = selectVillain.executeQuery();
            villainSetUpdated.next();
            villainId = villainSetUpdated.getInt("id");
    ...
    private static int getOrInsertTown(Connection connection, String minionTown) throws SQLException {
        ...
        if (!townSet.next()) {
            ...
            ResultSet townSetUpdated = selectTown.executeQuery();
            townSetUpdated.next();
            townId = townSetUpdated.getInt("id");
